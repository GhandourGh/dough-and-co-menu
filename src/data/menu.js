...
export const menu = [
  ...
  { id: "flatwhite", category: "coffee", badge: "Bestseller", name: "Flat white", description: "Six ounces of glossy microfoam and a double shot.", price: 4.75, image: "/assets/flatwhite.webp", featured: true },
  { id: "cappuccino", category: "coffee", name: "Cappuccino", description: "Classic thirds, dusted with our darkest cocoa.", price: 4.5 },
  { id: "latte", category: "coffee", name: "Latte", description: "Twelve ounces, gently sweet and endlessly smooth.", price: 5 },
  ...
  { id: "coldbrew", category: "iced", name: "Cold brew", description: "Steeped for eighteen slow hours, served over ice.", price: 4.75 },
  { id: "icedlatte", category: "iced", badge: "Bestseller", name: "Iced latte", description: "A double shot and cold milk over clear ice.", price: 5, image: "/assets/icedlatte.webp", featured: true },
  { id: "icedamericano", category: "iced", name: "Iced americano", description: "Espresso, cold water, and one satisfyingly big cube.", price: 4.5 },
  { id: "esptonic", category: "iced", badge: "New", name: "Espresso tonic", description: "Citrus-led espresso, tonic, and a wide orange peel.", price: 5.5 },
  { id: "icedmocha", category: "iced", name: "Iced mocha", description: "Ganache, cold milk, and espresso. No syrup.", price: 5.75 },
  ...
  { id: "icedmatcha", category: "other", badge: "New", name: "Iced matcha", description: "The same ceremonial whisk with plenty of ice.", price: 5.75, image: "/assets/matcha.webp" },
  ...
  { id: "croissant", category: "bakery", name: "Butter croissant", description: "Laminated over three days and baked deep gold.", price: 4 },
  ...
  { id: "cookie", category: "bakery", name: "Chocolate cookie", description: "Sea salt on top and still soft in the middle.", price: 3.25 },
